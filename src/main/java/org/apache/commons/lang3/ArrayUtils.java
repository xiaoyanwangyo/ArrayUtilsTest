...
//        return newArray;
     ...
     */
    @SafeVarargs
    public static <T> T[] insert(int index, final T[] array, final T... values) {
        /*
...
//        return result;
        ...
        T[] result = (T[]) java.lang.reflect.Array.newInstance(array.getClass().getComponentType(), array.length + values.length);
        System.arraycopy(array, 0, result, 0, index);
        System.arraycopy(values, 0, result, index, values.length);
        System.arraycopy(array, index, result, index + values.length, array.length - index);
        return result;
